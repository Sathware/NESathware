...
DesktopWindow::DesktopWindow(HINSTANCE hInstance, int nCmdShow, const std::wstring& windowTitle)
	: m_windowTitle(windowTitle), m_windowsMessage()
{
	WNDCLASSEX window{
		sizeof(WNDCLASSEX),
		0,
	...
	RECT clientArea{0, 0, clientArea_width, clientArea_height};
